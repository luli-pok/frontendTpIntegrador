...
function filtrarProductos(array){
    barraBusqueda.addEventListener("keyup", function(){
        ...
        let productosFiltrados = array.filter(producto => producto.name.toLowerCase().includes(valorInput));
...
document.getElementById("ordenar-nombre").addEventListener("click", function() {
    const ordenadoPorNombre = [...products].sort((a, b) => a.name.localeCompare(b.name));
    mostrarProductos(ordenadoPorNombre);
});

document.getElementById("ordenar-precio").addEventListener("click", function() {
    const ordenadoPorPrecio = [...products].sort((a, b) => a.price - b.price); // ✅
